...
const adminFeatures = [
  {
    icon: Lock,
    label: 'Secure Access',
    desc: 'Enterprise-grade encryption for all institutional data.',
  },
  {
    icon: Database,
    label: 'Bulk Records',
    desc: 'Manage thousands of student profiles and academic logs.',
  },
  {
    icon: UserCheck,
    label: 'Verification',
    desc: 'Audit and validate student credentials in real-time.',
  },
];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (result?.error) {
      ...
      if (
        ...
        setError(
          'This account does not have administrator privileges. Please use the Student Portal.',
        );
        setLoading(false);
      }
    }
            ...
            {adminFeatures.map((f, i) => (
              ...
              >
                ...
                <div>
                  ...
                  <p className='text-xs text-purple-muted-foreground mt-1 font-medium leading-relaxed'>
                    {f.desc}
                  </p>
                </div>
              </motion.div>
      ...
      <div className='flex-1 flex flex-col justify-center items-center p-8 relative overflow-hidden'>
        ...
        >
          <div className='mb-10 text-center lg:text-left'>
            ...
            <p className='text-purple-muted-foreground mt-2 font-medium'>
              Verify your identity to manage institutional records.
            </p>
          </div>
          ...
          <div className='bg-white rounded-5xl p-10 shadow-purple border border-purple-border/20'>
            <form onSubmit={handleSubmit} className='space-y-6'>
              ...
              <div className='space-y-2'>
                <Label
                  htmlFor='email'
                  className='text-[10px] font-black text-purple-foreground uppercase tracking-widest ml-1'
                >
                  Admin Email Address
                </Label>
                <Input
              ...
              <div className='space-y-2'>
                <div className='flex justify-between items-center ml-1'>
                  <Label
                    htmlFor='password'
                    className='text-[10px] font-black text-purple-foreground uppercase tracking-widest'
                  >
                    Secure Password
                  </Label>
                </div>
